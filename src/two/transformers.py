...
class DataFrameSelector(BaseEstimator, TransformerMixin):
    ...
    def transform(self, X, y=None):
        v = X[self.attribute_names].values
        return v
...
class ColumnToIndexTransformer(BaseEstimator, TransformerMixin):
    def __init__(self, full_columns):
    ...
    def transform(self, X, y=None):
        return [self.full_columns.index(x) for x in X]
